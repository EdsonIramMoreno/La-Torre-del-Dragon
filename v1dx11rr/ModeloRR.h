...
public:
	...
	public:
		...
		Builder* setModelPath(char* ModelPath) {
			this->ModelPath = ModelPath;
			return this;
		}

		Builder* setspecularTexturePath(WCHAR* specularTexturePath) {
			this->specularTexturePath = specularTexturePath;
			return this;
		}

		Builder* setcolorTexturePath(WCHAR* colorTexturePath) {
			this->colorTexturePath = colorTexturePath;
			return this;
		}
